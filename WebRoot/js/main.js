...
$(document).ready(function(e) {
			...
			$(document).on("click",".item:not(.lastItem)",function(e){
        ...
        var CalendarHandler = {
            ...
            initialize: function() {
                ...
                $("#context").css("height", $("#CalendarMain").height() - 25 + "px");
...
function setContentTab(name, curr, n) {
    for (i = 1; i <= n; i++) {
        ...
        var countMore = document.getElementById("note-"+i);
        menu.className = i == curr ? "up" : "";
        if (i == curr) {
            cont.style.display = "block";
            countMore.style.display = "block";
        } else {
            cont.style.display = "none";
            countMore.style.display = "none";
        }
    }
}
...
$(function(){
        /*11-1增加修改*/
        $('.jt-edit .js_li').each(function(){
            $(this).hover(function(){
                $(this).find('.di_xl').css({'visibility':'visible'});
            },function(){
                $(this).find('.di_xl').css({'visibility':'hidden'});
            })
        })
        /*11-1增加修改*/
    });
